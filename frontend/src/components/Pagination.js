const Pagination = ({setupsPerPage, totalSetups, currentPage, paginate}) => {
  ...
  return ( 
    <nav className="flex items-center justify-between px-4 pb-10 border-t border-gray-200 sm:px-0">
      ...
      <div className="hidden md:-mt-px md:flex">
        {pageNumbers.map(number => (
          ...
          : 
          'focus:outline-none inline-flex items-center px-4 pt-4 text-sm font-medium text-indigo-600 border-t-2 border-indigo-500'}
