        ...
        <Form className='max-w-6xl px-5 m-10 mx-auto space-y-8 divide-y divide-gray-200'>
          <div className='space-y-8 divide-y divide-gray-200 sm:space-y-5'>
            <div>
              <div>
                ...
                <p className='max-w-2xl mt-1 text-sm text-gray-500'>Provide a short introduction for your setup</p>
              </div>
              <div className='mt-6 space-y-6 sm:mt-5 sm:space-y-5'>
                <div className='sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5'>
                  <label className='block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2'>Setup title</label>
            ...
            <div className='pt-8 divide-y divide-gray-200 sm:pt-10'>
              <div>
                ...
                <p className='max-w-2xl mt-1 text-sm text-gray-500'>
                  Add all apps, tools, programming languages, frameworks and libraries you use in development
                </p>
              </div>
                  ...
                  <div className='flex items-center mt-3 sm:col-span-2'>
                    ...
                    <span className='ml-3'>
                      <button
                        ...
                        <svg
                          xmlns='http://www.w3.org/2000/svg'
                          className='w-5 h-5 mr-1 -ml-2 text-gray-400'
                          viewBox='0 0 20 20'
                          fill='currentColor'>
                          <path
                            fillRule='evenodd'
          ...
          <div className='pt-5'>
            <div className='flex justify-end'>
              ...
              <button
                type='submit'
                className='inline-flex justify-center px-4 py-2 ml-3 text-sm font-medium text-white bg-blue-500 border border-transparent rounded-md shadow-sm hover:bg-blue-700'>
                Save
              </button>
            </div>
          </div>
